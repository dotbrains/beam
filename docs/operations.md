...
SQLite snapshots store service webhook tokens and agent credential tokens as
hashes, but backups still contain event payloads, callback metadata, device
records, and limiter state.
