...
beam auth status
beam auth connections list
beam auth connections revoke adc_abc
...
revokes device-issued credentials before clearing local config. `auth
...
beam services update svc_abc --image "" --url ""
