...
| 8. CLI parity | Auth login/status/logout, env overrides, services, notify, ask/wait, activity commands, JSON stdout, empty stdout on API errors, stderr diagnostics, and exit codes are covered. | Evidence present |
