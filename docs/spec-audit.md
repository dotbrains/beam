...
| 3. Service dashboard API | Service CRUD, token rotation, defaults, event history, devices, CLI token-safe service output, and auth connection revocation are implemented and tested. | Evidence present |
