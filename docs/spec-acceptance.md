...
| Symbols, layouts, and privacy modes are supported. | `TestLiveActivityViewStateMapsEveryBeamSymbolToSystemSymbol`, `TestLiveActivityViewsCompileForEveryLayout`, `TestLiveActivityViewStateRedactsPrivateDetail` |
